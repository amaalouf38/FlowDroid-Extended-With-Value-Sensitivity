...
public abstract class AbstractTaintWrapper implements ITaintPropagationWrapper {
	 ...
	 * has been executed
	 */
	public abstract Set<AccessPath> getTaintsForMethodInternal(Stmt stmt, AccessPath taintedPath, ByReferenceBoolean killSource, ByReferenceBoolean killAll);
	...
	public Set<Abstraction> getTaintsForMethod(Stmt stmt, Abstraction d1,
			Abstraction taintedPath,ByReferenceBoolean killSource, ByReferenceBoolean killAll) {

		// Compute the tainted access paths
		Set<AccessPath> aps = getTaintsForMethodInternal(stmt,taintedPath.getAccessPath(), killSource,  killAll);
