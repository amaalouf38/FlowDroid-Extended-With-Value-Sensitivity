...
public class InfoflowPerformanceData {
	...
	private long totalRuntimeSeconds = -1;
	private long intervalRuntimeSeconds = -1;
	...
	public void setIntervalRuntimeSeconds(long intervalRuntimeSeconds) {
		this.intervalRuntimeSeconds = intervalRuntimeSeconds;
	}
	public long getIntervalRuntimeSeconds() {
	...
	public int hashCode() {
		...
		result = prime * result + (int)totalRuntimeSeconds;
		return result;
	}
