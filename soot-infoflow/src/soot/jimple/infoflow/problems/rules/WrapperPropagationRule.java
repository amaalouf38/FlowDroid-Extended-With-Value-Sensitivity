...
public class WrapperPropagationRule extends AbstractTaintPropagationRule {
	 ...
	 */
	private Set<Abstraction> computeWrapperTaints(Abstraction d1, final Stmt iStmt, Abstraction source,ByReferenceBoolean killSource, ByReferenceBoolean killAll) {
		...
		Set<Abstraction> res = getManager().getTaintWrapper().getTaintsForMethod(iStmt, d1, source, killSource,  killAll);
		if (res != null) {
	...
	public Collection<Abstraction> propagateCallToReturnFlow(Abstraction d1, Abstraction source, Stmt stmt,
		...
		Collection<Abstraction> wrapperTaints = computeWrapperTaints(d1, stmt, source, killSource,  killAll);
